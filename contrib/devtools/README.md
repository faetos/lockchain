...
LockChain-Project/LockChain repository.
...
Setup
---------
Configuring the github-merge tool for the LockChain repository is done in the following way:

    git config githubmerge.repository LockChain-Project/LockChain
...
A script to optimize png files in the LockChain
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_lockchain: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_lockchain: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_lockchain: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_lockchain: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
