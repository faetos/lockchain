...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/faetos/gitian.sigs.git'])
    if not os.path.isdir('lockchain-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/faetos/lockchain-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('lockchain'):
        subprocess.check_call(['git', 'clone', 'https://github.com/faetos/lockchain.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/faetos/lockchain', help='Specify the URL of the repository. Default is %(default)s')
