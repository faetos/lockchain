...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    /* STDrwM7dDmaJxR1mW1e56TZtNtM6PHfjHB is not owned by the test wallet. */
    BOOST_CHECK_THROW(CallRPC("setaccount STDrwM7dDmaJxR1mW1e56TZtNtM6PHfjHB nullaccount"), runtime_error);
