...
public:
    ...
    /** The maxnode count that we will allow the see-saw reward payments to be off by */
    int MaxnodeCountDrift() const { return nMaxnodeCountDrift; }
