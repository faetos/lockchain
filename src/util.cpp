...
bool fEnableZeromint = false; // disabled autominting of LCKC->zLCKC
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
		...
		ptrCategory->insert(string("maxnode"));
                ptrCategory->insert(string("maxpayments"));
                ptrCategory->insert(string("zero"));
                ptrCategory->insert(string("mnbudget"));
                ptrCategory->insert(string("maxbudget"));
            }
        }
...
{
    boost::filesystem::path pathConfigFile(GetArg("-maxconf", "maxnode.conf"));
    if (!pathConfigFile.is_complete()) pathConfigFile = GetDataDir() / pathConfigFile;
    return pathConfigFile;
}
