...

{
    ...
    QString windowTitle = tr("LockChain Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    connect(openMAXConfEditorAction, SIGNAL(triggered()), rpcConsole, SLOT(showMAXConfEditor()));
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LockChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lockchain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LockChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about LockChain Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for LockChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LockChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LockChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a LockChain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LockChain Core help message to get a list with possible LockChain command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        tools->addAction(openMAXConfEditorAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LockChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::createTrayIconMenu()
{
    ...
    trayIconMenu->addAction(openMAXConfEditorAction);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LockChain network", "", count));
}
...
{
    QString strTitle = tr("LockChain Core"); // default title
