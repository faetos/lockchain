...
#define QAPP_ORG_NAME "LockChain"
#define QAPP_ORG_DOMAIN "lockchainchain.org"
#define QAPP_APP_NAME_DEFAULT "LockChain-Qt"
#define QAPP_APP_NAME_TESTNET "LockChain-Qt-testnet"
