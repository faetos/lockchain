...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR LYTX</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
