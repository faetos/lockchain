...
cp ../icons/bitcoin.png lockchain-1024x1024.png
for b in 16 32 128 256 512
do
convert lockchain-1024x1024.png -resize ${b}x${b} icon_${b}x${b}.png
# *Should* be:
# convert lockchain-1024x1024.png -unsharp 0 -resize $((b*2))x$((b*2)) icon_${b}x${b}@2x.png
...
cp lockchain-1024x1024.png icon_512x512@2x.png
...
rm -f icon_* lockchain-1024x1024.png
