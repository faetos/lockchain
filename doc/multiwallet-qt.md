...
In order to support loading of multiple wallets in lockchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lockchain.cpp.
...
Changes to lockchain.cpp
----------------------
lockchain.cpp is the entry point into lockchain-qt, and as such, will require some minor modifications to provide hooks for
