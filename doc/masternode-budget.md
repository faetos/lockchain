...
LockChain now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<lockchain_address\> \<monthly_payment_lockchain\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ LockChain, _12_ times over the course of a year totaling _24000_ LockChain.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<lockchain_address\> \<monthly_payment_lockchain\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` LockChain.
