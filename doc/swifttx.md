...
This mechanism has been integrated into Bitcore-Node-LockChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LockChain-Project/insight-api-lockchain#web-socket-api](https://github.com/LockChain-Project/insight-api-lockchain#web-socket-api) 
* API: [https://github.com/LockChain-Project/insight-api-lockchain#swifttx-transactions](https://github.com/LockChain-Project/insight-api-lockchain#swifttx-transactions) 
...
By default, the LockChain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LockChain Core daemon:
